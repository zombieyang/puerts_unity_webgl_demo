import { IntPtrManager, NativeObjectMap } from "./library";
...
export function init() {
    ...
    var intPtrManagerInstance: IntPtrManager = null;
    var getIntPtrManager = function () {
        if (!intPtrManagerInstance) {
            intPtrManagerInstance = new IntPtrManager();
        }
        return intPtrManagerInstance
    }
    var nativeObjectMap = new NativeObjectMap();
    ...
    function toCSString(returnStr: string) {
    ...
    function callV8FunctionCallback(functionPtr: IntPtr, selfPtr: IntPtr, infoIntPtr: IntPtr, paramLen: number, data: number) {
    ...
    function makeV8FunctionCallbackFunction(functionPtr: IntPtr, data: number) {
        return function () {
    ...
    function callV8ConstructorCallback(functionPtr: IntPtr, infoIntPtr: IntPtr, paramLen: number, data: number) {
        Module.SendMessage('__PuertsBridge', 'SetInfoPtr', infoIntPtr);
        Module.SendMessage('__PuertsBridge', 'SetData', data);
        Module.SendMessage('__PuertsBridge', 'SetParamLen', paramLen);
    ...
    function callV8DestructorCallback(functionPtr: IntPtr, selfPtr: IntPtr, data: number) {
