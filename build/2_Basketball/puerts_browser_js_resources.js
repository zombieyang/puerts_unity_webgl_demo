        ...
        window.PUERTS_JS_RESOURCES = {"Base/base.mjs": (function(exports, require, module, __filename, __dirname) {
            "use strict";
...
exports.JsBehaviour = JsBehaviour;
        }),"entry.mjs": (function(exports, require, module, __filename, __dirname) {
            "use strict";
...
var _JSGameManager = require("./JSGameManager.mjs");
var _JSBallBehaviour = require("./JSBallBehaviour.mjs");
function makeFactory(cls) {
  return function (...args) {
    return new cls(...args);
  };
}
const JSBallBehaviourFactory = makeFactory(_JSBallBehaviour.JSBallBehaviour);
exports.JSBallBehaviour = JSBallBehaviourFactory;
const JSGameManagerFactory = makeFactory(_JSGameManager.JSGameManager);
exports.JSGameManager = JSGameManagerFactory;
        }),"JSBallBehaviour.mjs": (function(exports, require, module, __filename, __dirname) {
            "use strict";
...
var _base = require("./Base/base.mjs");
var _JSGameManager = require("./JSGameManager.mjs");
class JSBallBehaviour extends _base.JsBehaviour {
  OnTriggerEnter(trigger) {
    if (trigger == _JSGameManager.JSGameManager.instance._mb.PrescoreTrigger) {
      this.prescore = true;
    }
    if (trigger == _JSGameManager.JSGameManager.instance._mb.ScoredTrigger && this.prescore) {
      console.log("得分");
    }
  }
}
exports.JSBallBehaviour = JSBallBehaviour;
        }),"JSGameManager.mjs": (function(exports, require, module, __filename, __dirname) {
            "use strict";
...
var _base = require("./Base/base.mjs");
class JSGameManager extends _base.JsBehaviour {
  Start() {
    this.spawnBall();
