...
public class WebGLPuertsPostProcessor {
    ...
    {
        string PuertsWebglJSRoot = Path.GetFullPath("Packages/com.tencent.puerts.webgl.devtool/Javascripts~/");
    ...
    static void npmInstall() 
    {
        ...
        try 
        {
            ...
            ");
            npmInstaller(Path.GetFullPath("Packages/com.tencent.puerts.webgl.devtool/Javascripts~"));
        }
        catch(Exception e)
        {
            UnityEngine.Debug.LogError("Npm install failed. you can cd into 'Packages/com.tencent.puerts.webgl.devtool/Javascripts~' to run 'npm install' by yourself");
        }
    }
    ...
    {
        return Directory.Exists(Path.GetFullPath("Packages/com.tencent.puerts.webgl.devtool/Javascripts~/node_modules"));
    }
